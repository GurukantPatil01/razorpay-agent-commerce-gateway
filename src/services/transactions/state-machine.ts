...
const VALID_TRANSITIONS: Record<TransactionState, TransactionState[]> = {
  ...
  PAYMENT_PENDING: ['PAYMENT_PROCESSING', 'PAYMENT_SUCCESS', 'PAYMENT_FAILED', 'PAYMENT_EXPIRED'],
  ...
  PAYMENT_FAILED: ['PAYMENT_PENDING', 'PAYMENT_PROCESSING', 'PAYMENT_SUCCESS', 'APPROVAL_PENDING'], // Allowed for safe retry
